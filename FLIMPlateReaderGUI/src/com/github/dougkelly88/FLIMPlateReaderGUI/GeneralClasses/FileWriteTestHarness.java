...
import com.github.dougkelly88.FLIMPlateReaderGUI.GeneralClasses.FileWrite;
 ...
 */
public class FileWriteTestHarness {
  
  /**
   * Constructor
   *
   */
  public FileWriteTestHarness() {         
  }
   ...
   *
   */
  public void generateDummyData(String fileOut) throws Exception {
    
//    String fileOut = "C:/Users/dk1109/FLIMFromJava.ome.tiff";
    ...
    String description = " FLIM test data";
    FileWrite Writer = new FileWrite(fileOut, description);
    FileWriteTestHarness reader = new FileWriteTestHarness();
    ...
    boolean ok = Writer.init(sizeX, sizeY, sizet, delayList, exposureTimes);
